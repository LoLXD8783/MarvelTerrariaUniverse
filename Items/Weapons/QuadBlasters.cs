...
{
	public class QuadBlasters : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("Star-Lord's primary combat weapons");
		}
		...
		public override void SetDefaults() {
			...
			// Item.UseSound = SoundID.Item4; // The sound that this item plays when used.
